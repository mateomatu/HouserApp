...
class OrdersController extends Controller
{
    ...
    public function OrdersByUser($id)
    {
        $ordersByUser = DB::table('orders')
            ->select('orders.id_order', 'houser.orders.fk_houser', 'houser.user.name', 'services.title', 'orders_states.state', 'orders.created_at', 'orders.user_message', 'orders.houser_message', 'orders.read_at')
